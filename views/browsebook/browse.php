            ...
            <div class="col-lg-8 col-md-8 col-sm-8 col-xm-8">
                <div class="panel panel-default" style="border-radius: 20px; padding-left: 10px; padding-right: 10px; padding-bottom: 10px; height: 500px;">
                    ...
                    <div class="panel-body" style="margin-top: 60px;border-radius: 20px; background-color: #1ab7ea; height: 350px; position: absolute; width: 94.6%;">
                        <i class="fa fa-angle-left arrow" aria-hidden="true" style="color: rgba(0,0,0, 0.1); font-size: 200px; left: 10px;vertical-align: middle; line-height: 300px; position: absolute; z-index: 1000;" ng-click="actionPrev()"></i>
                        <i class="fa fa-angle-right arrow" aria-hidden="true" style="color: rgba(0,0,0, 0.1); font-size: 200px; right: 10px; vertical-align: middle; line-height: 300px; position: absolute; z-index: 1000;" ng-click="actionNext()"></i>
